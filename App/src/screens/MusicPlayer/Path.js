...
export const selectCurve = (path, x) => {
  "worklet";
  const result = {
    from: path.move,
    curve: null,
...
export const getYForX = (path, x, precision = 2) => {
  "worklet";
...
export const parse = (d) => {
  const segments= normalizeSVG(absSVG(parseSVG(d)));
